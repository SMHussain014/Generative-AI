...
from mine_todos.database import engine, get_session
from mine_todos.models import Todo, Todo_Created, Todo_Edited
...
app: FastAPI = FastAPI(
    lifespan = lifespan, 
    title = "Mine_Todos API and Docker Compose", 
    description = "This is an API of Todos, integrated with Docker Compose", 
    version = "0.1.4",
    servers=[
        {
...
@app.get("/")
async def root():
    return {"message": "Welcome to Mine_Todos App with Docker Compose"}
